      ...
      <div
        className={
          locationAbout
            ...
            : " containerCollaps__header containerCollaps__header__housing"
        }
        onClick={handleToggle}>
        <p className={
            locationAbout
              ? " containerCollaps__title containerCollaps__title__about"
              : " containerCollaps__title containerCollaps__title__housing"
          }>
          {title}
        </p>

        <div className="containerCollaps__arrows">
          {open 
