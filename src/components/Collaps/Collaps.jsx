...
const Collaps = ({title, content}) => {
  ...
  return (
    <div className={locationAbout ? " containerCollaps containerCollaps__about" : " containerCollaps containerCollaps__housing" }>
      <div className={locationAbout ? " containerCollaps__header containerCollaps__header__about" : " containerCollaps__header containerCollaps__header__housing"} onClick={handleToggle}>
        ...
        <div className="containerCollaps__arrows" >{open ? <img className="containerCollaps__arrow" src={arrowUp} alt="" />  : <img className="containerCollaps__arrow" src={arrowDown} alt="" />}</div> 
      </div>
      {open && (
